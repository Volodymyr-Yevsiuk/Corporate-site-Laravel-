...
class MenusController extends AdminController
{
    ...
    {
        if(Gate::denies('VIEM_ADMIN_MENU')) {
            abort(403);
        }
    ...
    public function getMenus() {
        ...
        $mBuilder = \Menu::make('forMenuPart', function($m) use ($menu) {
    ...
    public function edit($id)
    {
        ...
        $this->content = view(config('settings.theme').'.admin.menus_create_content')->with(['menu' => $menu, 'option' => $option, 'type' => $type ,'menus'=>$menus, 'categories' => $list, 'articles' => $articles, 'filters' => $filters, 'portfolios' => $portfolios])->render();
